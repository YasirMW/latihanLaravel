...
<body class="bg-gradient-primary">
    ...
    <div class="card-header py-3">
        ...
        <div class="card-body p-0">
           ...
           <form action="/update/{{$s->nis}}" method="POST" class="user">
                            @csrf
                            @method('PUT')
                              ...
                              <div class="form-group"><table><tr>
                               ...
                               <input type="number" class="form-control form-control-user" 
                                    placeholder="NIS" value="{{$s->nis}}" name="nis" required>
                            </div>
                            <div class="form-group"><table><tr>
                               <td>Nama Siswa</td><td>:</td></tr></table>
                               <input type="text"  class="form-control form-control-user"
                                    placeholder="" value="{{$s->nama}}" name="nama"required>
                            </div>
                            <div class="form-group"><table><tr>
                               <td>Tempat Lahir</td><td>:</td></tr></table>
                               <input type="text"  class="form-control form-control-user"
                                    placeholder="" value="{{$s->tempat_lahir}}" name="tempat_lahir"required>
                            </div>
                            <div class="form-group"><table><tr>
                               <td>Tanggal Lahir</td><td>:</td></tr></table>
                               <input type="date"  class="form-control form-control-user"
                                    placeholder="" value="{{$s->tgl_lahir}}" name="tgl_lahir"required>
                            </div>
                            <div class="form-group"><table><tr>
                               <td>Asal Sekolah</td><td>:</td></tr></table>
                               <input type="text"  class="form-control form-control-user"
                                    placeholder="" value="{{$s->sekolah}}" name="sekolah"required>
                            </div>
                            
                            <div class="form-group"><table><tr>
                               <td>Alamat</td><td>:</td></tr></table>
                               <input type="text" class="form-control form-control-user" value="{{$s->alamat}}" name="alamat"required>
                            </div>
                            <div class="form-group"><table><tr>
                               <td>No Telp</td><td>:</td> </td></tr></table><div class="col-lg-12">
                                <input class="form-control form-control-user" type="number" name="notelp" value="0{{$s->notelp}}" required></div>
                            </div>
